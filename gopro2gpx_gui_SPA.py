...
# Clase auxiliar para redirigir la salida a un widget Text de Tkinter
class TextRedirector:
    def __init__(self, widget):
        self.widget = widget
    def write(self, s):
        if s.strip() != "":
            # Usar after para asegurarnos que la actualización se realice en el hilo principal
...
class GoPro2GPXGUI(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("GoPro2gpx - Interfaz gráfica")
    ...
    def on_tab_change(self, event):
        ...
        if selected == str(self.descriptor_frame):
            ...
            # Tamaño mayor para la pestaña Principal
    ...
    def create_descriptor_widgets(self):
        ...
        self.text_descriptor.insert("end", "Sobre GoPro2gpx:\n", "bold")
    ...
    def on_process(self):
        ...
        # Limpiar el área de texto verbose.
    ...
    def run_processing(self, args, selected_format):
        try:
            ...
            # En modo GUI, redefinimos sys.exit para evitar cierres inesperados
            sys.exit = lambda code=0: None

            # Si el modo Verbose está activado, redirigir la salida al widget Text
            ...
            # Manejo interno de errores o registro en un log
    ...
    def post_process_csv(self, csv_path):
        # Implementar procesamiento adicional para CSV si es necesario
        pass

    def post_process_gpx(self, gpx_path):
        # Implementar procesamiento adicional para GPX si es necesario
        pass

    def post_process_kml(self, kml_path):
        # Implementar procesamiento adicional para KML si es necesario
        pass
